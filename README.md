...
Local Installation: Download and install MongoDB Community Server from mongodb.com.

MongoDB Atlas (Cloud): Recommended for easier setup and deployment. Create a free cluster at cloud.mongodb.com.

API Keys:

Google Gemini API Key: Obtain one from Google AI Studio.

OpenWeatherMap API Key: Register and get your key from openweathermap.org.
